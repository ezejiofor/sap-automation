...
function control_plane_showhelp {
    ...
    echo "#      --deployer_parameter_file DEPLOYER/MGMT-NOEU-DEP00-INFRASTRUCTURE/MGMT-NOEU-DEP00-INFRASTRUCTURE.json \  #"
    echo "#      --library_parameter_file LIBRARY/MGMT-NOEU-SAP_LIBRARY/MGMT-NOEU-SAP_LIBRARY.json \                      #"
    echo "#                                                                                                               #"
    echo "#   Example:                                                                                                    #"
    echo "#                                                                                                               #"
    echo "#   \$SAP_AUTOMATION_REPO_PATH/scripts/deploy_controlplane.sh \                                                  #"
    echo "#      --deployer_parameter_file DEPLOYER/DEV-NOEU-DEP00-INFRASTRUCTURE/DEV-NOEU-DEP00-INFRASTRUCTURE.json  \ #"
    echo "#      --library_parameter_file LIBRARY/DEV-NOEU-SAP_LIBRARY/DEV-NOEU-SAP_LIBRARY.json \                      #"
...
function workload_zone_showhelp {
    ...
    echo "#      --parameterfile DEV-NOEU-SAP01-INFRASTRUCTURE                                         #"
    echo "#                                                                                             #"
    echo "#   Example:                                                                                  #"
    echo "#                                                                                             #"
    echo "#   [REPO-ROOT]deploy/scripts/install_workloadzone.sh \                                       #"
...
function showhelp {
    ...
    echo "#      --parameterfile DEV-NOEU-SAP01-EQ2 \                                             #"
