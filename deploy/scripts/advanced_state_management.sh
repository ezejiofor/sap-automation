...
function showhelp {
    ...
    echo "#      --parameterfile DEV-NOEU-SAP01-EQ2.tfvars \                                                               #"
    echo "#      --type sap_system                                                                                         #"
    echo "#      --subscription xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx                                                       #"
    echo "#      --storage_account_name mgmtnoeutfstatef5f                                                                 #"
    echo "#      --terraform_keyfile DEV-NOEU-SAP01-EQ2.terraform.tfstate                                                  #"
    echo "#      --tf_resource_name module.sap_system.azurerm_resource_group.deployer[0]                                   #"
    echo "#      --azure_resource_id /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/DEV-NOEU-SAP01-X01 #"
    echo "#                                                                                                                #"
    echo "#                                                                                                                #"
    echo "##################################################################################################################"
}
